        ...
        <section className="about-me flex flex-col justify-center items-center w-11/12">
          ...
          <div className="sm:flex sm:flex-col lg:flex-row-reverse sm:justify-center sm:items-center">
            ...
            <p className="text-container sm:w-4/5 text-red-300 text-sm sm:text-base lg:text-xl font-normal p-1 sm:p-2 lg:m-4 lg:p-4">
              I am a student currently pursuing my Masters, specializing in Machine Learning at Dhirubhai Ambani University, Gandhinagar and have previously worked as an Associate Software Engineer - Intern (React) at <a href="https://coditas.com/" className="text-blue-300">Coditas</a>.  
              <br/>
              My current area of research is Adversarial Machine Learning, with a focus on creating robust classifiers to Adversarial Patch Attack . Also I had taken part in the "Adversarial Attack Challenge" conducted by Youverse as a part of IEEE IJCB 2025 and won the 2nd and 3rd prizes in it. 
              <br/>
              I also have exposure/experience in CV, Pytorch, React, Typescript/JavaScript, SCSS/SASS and Tailwind.
              <p>
        ...
        <section className="tech-stack w-11/12 mb-4 md:mb-8">
          ...
          <div className=" grid grid-cols-2 justify-center">
            <div className="tech-stack-items p-6 sm:p-8 lg:p-12 m-auto">
              <SiTypescript className="text-slate-300 scale-[2.5] sm:scale-[3.5] lg:scale-[4.25] hover:text-slate-400 rounded-sm" />
            </div>
            <div className="tech-stack-items p-6 sm:p-8 lg:p-12 m-auto">
            ...
            <div className="tech-stack-items p-6 sm:p-8 lg:p-12 lg:scale-150 m-auto">  
              <RiTailwindCssFill className="text-slate-300 scale-[2.5] sm:scale-[3.5] lg:scale-[4] hover:text-slate-400" />
            </div>
            <div className="tech-stack-items p-6 sm:p-8 lg:p-12 m-auto">
              <i className="fa-brands fa-sass scale-[3] sm:scale-[4] lg:scale-[5] text-slate-300 hover:text-slate-400"></i>
            </div>
            <div className="tech-stack-items p-6 sm:p-8 lg:p-12 m-auto">
