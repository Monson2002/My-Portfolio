...
export default function Home() {
  ...
  return (
    <>
      <main
        className="home h-screen w-screen bg-cover bg-fixed flex flex-col justify-between items-center"
        id="home">
        <div
          className={`navbar-toggle fixed flex justify-between items-center w-full p-2 bg-gray-800 z-10`}>
          <div className="logo flex justify-center items-center">
            <a
              href="https://www.linkedin.com/in/monson-verghese-a26061231/"
              target="_blank"
            ...
            <a
              href="https://github.com/Monson2002"
              target="_blank"
              rel="noopener noreferrer">
            ...
            <a
              href="https://twitter.com/monson2002"
              target="_blank"
              rel="noopener noreferrer">
          ...
          <div className="dropdown-md hidden md:flex">
            <div className="dropdown">
              <ul className="text-gray-300 flex justify-center items-center md:mx-2 rounded-lg">
                <a href="#home">
                  <i className="fa-solid fa-house p-2 m-2 sm:m-4 lg:mx-8 w-auto md:scale-150 hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:text-slate-100"></i>
                </a>
                <a href="#about">
                  <i className="fa-solid fa-user p-2 m-2 sm:m-4 lg:mx-8 w-auto md:scale-150 hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:text-slate-100"></i>
                </a>
                <a href="#projects">
                  <i className="fa-solid fa-briefcase p-2 m-2 sm:m-4 lg:mx-8 w-auto md:scale-150 hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:text-slate-100"></i>
                </a>
                <a href="#contact-us">
                  <i className="fa-solid fa-phone p-2 m-2 sm:m-4 lg:mx-8 w-auto md:scale-150 hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:text-slate-100"></i>
                </a>
              </ul>
            </div>
          </div>
          ...
          <div className="md:hidden">
            <i
              ...
              className="fa-solid fa-bars text-slate-300 sm:scale-150 p-2"></i>
            {navBar ? (
              <div className="dropdown">
                <ul className="absolute m-3 mt-4 left-0 w-11/12 bg-slate-900 text-gray-300 flex flex-col justify-start items-center p-2 sm:p-3 rounded-lg">
                  <a
                    href="#home"
                    className="flex hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100">
                    <i
                      className="fa-solid fa-house m-auto p-2 w-auto "
                      onClick={toggleNavbar}></i>
                    <li
                      className="p-2 w-auto text-lg font-normal"
                      onClick={toggleNavbar}>
                      Home
                    </li>
                  </a>
                  <a
                    ...
                    className="flex hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100">
                    <i
                      className="fa-solid fa-user m-auto p-2 w-auto "
                      onClick={toggleNavbar}></i>
                    <li
                      className="p-2 w-auto text-lg font-normal"
                      onClick={toggleNavbar}>
                  ...
                  <a
                    ...
                    className="flex hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100">
                    <i
                      className="fa-solid fa-briefcase m-auto p-2 w-auto "
                      onClick={toggleNavbar}></i>
                    <li
                      className="p-2 w-auto text-lg font-normal"
                      onClick={toggleNavbar}>
                  ...
                  <a
                    ...
                    className="flex hover:text-slate-400 hover:underline hover:underline-offset-4 hover:decoration-pink-500 active:bg-slate-800 active:text-slate-100">
                    <i
                      className="fa-solid fa-phone m-auto p-2 w-auto "
                      onClick={toggleNavbar}></i>
                    <li
                      className="p-2 w-auto text-lg font-normal"
                      onClick={toggleNavbar}>
        ...
        <div className="container p-2 sm:w-3/5 md:mt-7 lg:w-2/5">
          ...
          <div className="flex items-center justify-center lg:mt-4">
            <button
              onClick={() => {
                window.open(
                  "https://drive.google.com/file/d/1EeL1SdV6PxGfEG169qydIMwwPIAaFGpY/view?usp=sharing"
                );
              }}
        ...
        <div className="end">{/* Dummy div for vertical alignment */}</div>
      </main>
    </>
  );
}
